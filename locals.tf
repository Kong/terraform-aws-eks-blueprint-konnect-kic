locals {
  ...
  set_values = [
    ...
    },
    {
      ...
      value = "kong/kong-ingress-controller"
    },
    {
    ...
    {
      name = "controller.ingressController.runtimeGroupID"
    ...
    {
      name  = "gateway.env.cluster_control_plane"
      value = "${local.cluster_dns}:443"
    },
    {
      name  = "gateway.env.cluster_server_name"
